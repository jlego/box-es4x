...
function renderVal(field) {
  let newValue = { type: Array.isArray(field) ? 'Array' : field }, defaultValue = '';
  if (typeof field === 'object' && !Array.isArray(field)) {
    defaultValue = field.default;
    Object.assign(newValue, field);
  }
  switch (newValue.type) {
    ...
    case 'Object':
      ...
      break;
    case 'Date':
      newValue.value = newValue.value instanceof Date ? newValue.value : (newValue.value ?  new Date(newValue.value) : undefined);
      break;
    default:
      newValue.value = newValue.value ? newValue.value : defaultValue;
      break;
